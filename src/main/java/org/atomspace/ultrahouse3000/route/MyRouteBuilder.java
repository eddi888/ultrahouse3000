...
public class MyRouteBuilder extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("servlet:///workroom/lighton")
            ...
            .autoStartup(autoStartup)
            .to("tinkerforgegen://pinkpi:4223/RemoteSwitch?uid=oiZ&function=switchSocketA&houseCode2="+houseCode+"&receiverCode2=1&switchTo2=1");
        
        // http://0.0.0.0:8080/camel/workroom/lightoff
        from("servlet:///workroom/lightoff")
            .id("route-workroom-lightoff")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://pinkpi:4223/RemoteSwitch?uid=oiZ&function=switchSocketA&houseCode2="+houseCode+"&receiverCode2=1&switchTo2=0");
        
        // http://0.0.0.0:8080/camel/bedroom/ventilator-on
        from("servlet:///bedroom/ventilator-on")
            .id("route-bedroom-ventilator-on")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://pinkpi:4223/RemoteSwitch?uid=oiZ&function=switchSocketA&houseCode2="+houseCode+"&receiverCode2=4&switchTo2=1");
        
        // http://0.0.0.0:8080/camel/bedroom/ventilator-off
        from("servlet:///bedroom/ventilator-off")
            .id("route-bedroom-ventilator-off")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://pinkpi:4223/RemoteSwitch?uid=oiZ&function=switchSocketA&houseCode2="+houseCode+"&receiverCode2=4&switchTo2=0");
        
        // http://0.0.0.0:8080/camel/lobby/lighton
        from("servlet:///lobby/lighton")
            .id("route-string-of-lights-on")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://pinkpi:4223/RemoteSwitch?uid=oiZ&function=switchSocketA&houseCode2="+houseCode+"&receiverCode2=8&switchTo2=1");
        
        // http://0.0.0.0:8080/camel/lobby/lightoff
        from("servlet:///lobby/lightoff")
            .id("route-string-of-lights-off")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://pinkpi:4223/RemoteSwitch?uid=oiZ&function=switchSocketA&houseCode2="+houseCode+"&receiverCode2=8&switchTo2=0");
        
        // http://0.0.0.0:8080/camel/corridor/swtich
        from("servlet:///corridor/swtich")
            .id("route-corridor-switch")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rp9&function=setMonoflop&selectionMask="+0b1000+"&valueMask2="+0b0000+"&time=100");

        // http://0.0.0.0:8080/camel/kitchen/domelight/swtich
        from("servlet:///kitchen/domelight/swtich")
            .id("route-kitchen-domelight-switch")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rp9&function=setMonoflop&selectionMask="+0b0100+"&valueMask2="+0b0000+"&time=100");
        ...
        from("servlet:///kitchen/cabinetlight/swtich")
            ...
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rp9&function=setMonoflop&selectionMask="+0b0010+"&valueMask2="+0b0000+"&time=100");
        ...
        from("servlet:///kitchen/auxiliarylight/swtich")
            ...
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rp9&function=setMonoflop&selectionMask="+0b0001+"&valueMask2="+0b0000+"&time=100");

        // http://0.0.0.0:8080/camel/lounge/domelight/swtich
        from("servlet:///lounge/domelight/switch")
            .id("route-lounge-domelight-switch")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rpM&function=setMonoflop&selectionMask="+0b1000+"&valueMask2="+0b0000+"&time=100");

        // http://0.0.0.0:8080/camel/lounge/uplight/swtich
        from("servlet:///lounge/uplight/switch")
            .id("route-lounge-uplight-switch")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rpM&function=setMonoflop&selectionMask="+0b0100+"&valueMask2="+0b0000+"&time=100");
        
        // http://0.0.0.0:8080/camel/bedroom/domelight/swtich
        from("servlet:///bedroom/domelight/switch")
            .id("route-bedroom-domelight-switch")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rpM&function=setMonoflop&selectionMask="+0b0010+"&valueMask2="+0b0000+"&time=100");

        // http://0.0.0.0:8080/camel/bedroom/uplight/swtich
        from("servlet:///bedroom/uplight/switch")
            .id("route-bedroom-uplight-switch")
            .autoStartup(autoStartup)
            .to("tinkerforgegen://greypi:4223/IndustrialQuadRelay?uid=rpM&function=setMonoflop&selectionMask="+0b0001+"&valueMask2="+0b0000+"&time=100");
        
        // DOORBELL
        from("tinkerforgegen://greypi:4223/IO4?uid=h4K&callback=interrupt")
            .id("route-doorbell")
            .autoStartup(autoStartup)
            .filter().method(flipFlopFilter3000)
                .setHeader("type").constant("line")    
                .bean(message2DocumentTranslator)
                .to("tinkerforgegen://pinkpi:4223/DualRelay?uid=kPu&function=setMonoflop&relay=1&state=true&time=500")
                .end();
        
        
        
        // GAS USAGE
        from("tinkerforgegen://pinkpi:4223/line?uid=mRC&period=1000&init=setReflectivityCallbackPeriod&callback=ReflectivityListener")
            ...
            .filter().method(flipFlopFilter3000)
                ...
                .to("tinkerforgegen://pinkpi:4223/DualRelay?uid=kPu&function=setMonoflop&relay=2&state=true&time=500")
                .end();
        ...
        // TEMPERATUR INSIDE
//        from("tinkerforgegen://192.168.3.21:4223/Temperature?uid=qao&init=setTemperatureCallbackPeriod&period=5000&callback=TemperatureListener")
...
//        from("tinkerforgegen://192.168.3.21:4223/AmbientLight?uid=map&init=setIlluminanceCallbackPeriod&period=5000&callback=IlluminanceListener")
...
//            .to("couchdb:http://"+couchServer+":5984/ultrahouse3000?deletes=false");
        ...
        from("tinkerforgegen://greypi:4223/MotionDetector?uid=oTu&callback=MotionDetectedListener")
            .id("route-motiondetector-inside")
            .autoStartup(autoStartup)
            .setHeader("type").constant("motiondetector")
            .bean(message2DocumentTranslator)
            .to("couchdb:http://"+couchDbServer+":5984/ultrahouse3000?deletes=false")
            .to("tinkerforgegen://pinkpi:4223/PiezoSpeaker?uid=mKu&function=morseCode&morse=.... .- .-.. .-.. ---&frequency2=600");
